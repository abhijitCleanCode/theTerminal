...
const ServiceCard = ({ title }) => (
    <div className='w-full green-pink-gradient p-[1px] rounded-[15px]'>
        ...
        <button className='text-white text-[20px] font-semibold text-center'>
          {title}
        </button>
        </div>
    </div>
...
const Features = () => {
    return (
        <div className='bg-[#0B1531] shadow rounded-[30px] p-8' id='features'>
            <h3 className='text-2xl font-bold w-[78%] text-white'>What do we do</h3>
            ...
            <div className='py-8 grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <ServiceCard title="Build Zone"/>
                <ServiceCard title="Projects"/>
